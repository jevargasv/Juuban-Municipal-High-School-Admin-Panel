...
Student.create(first_name: "Usagi", last_name: "Tsukino", age: 14, date_of_birth: "June 30, 1978", year: "Freshman")
Student.create(first_name: "Ami", last_name: "Mizuno", age: 14, date_of_birth: "September 10, 1978", year: "Freshman")
Student.create(first_name: "Makoto", last_name: "Kino", age: 14, date_of_birth: "December 5, 1978", year: "Freshman")
Student.create(first_name: "Minako", last_name: "Aino", age: 14, date_of_birth: "October 22, 1978", year: "Freshman")
Student.create(first_name: "Haruka", last_name: "Tenoh", age: 15, date_of_birth: "January 27, 1978", year: "Sophomore")
Student.create(first_name: "Michiru", last_name: "Kaioh", age: 15, date_of_birth: "March 6, 1978", year: "Sophomore")
Student.create(first_name: "Seiya", last_name: "Kou", age: 16, date_of_birth: "July 30, 1976", year: "Junior")
Student.create(first_name: "Taiki", last_name: "Kou", age: 16, date_of_birth: "May 30, 1976", year: "Junior")
Student.create(first_name: "Yaten", last_name: "Kou", age: 16, date_of_birth: "February 8, 1976", year: "Junior")
Student.create(first_name: "Naru", last_name: "Osaka", age: 14, date_of_birth: "May 6, 1978", year: "Freshman")
Student.create(first_name: "Gurio", last_name: "Umino", age: 14, date_of_birth: "June 15, 1978", year: "Freshman")
Student.create(first_name: "Sonoko", last_name: "Ijuuin", age: 17, date_of_birth: "November 10, 1975", year: "Senior")
Student.create(first_name: "Yuji", last_name: "Kayama", age: 17, date_of_birth: "December 8, 1975", year: "Senior")
Student.create(first_name: "Nyanko", last_name: "Suzu", age: 15, date_of_birth: "July 5, 1978", year: "Sophomore")

StudentCohort.create(cohort_id: 1, student_id: 1)
StudentCohort.create(cohort_id: 1, student_id: 2)
StudentCohort.create(cohort_id: 1, student_id: 3)
StudentCohort.create(cohort_id: 1, student_id: 4)
StudentCohort.create(cohort_id: 1, student_id: 5)
StudentCohort.create(cohort_id: 1, student_id: 6)
StudentCohort.create(cohort_id: 1, student_id: 7)
StudentCohort.create(cohort_id: 1, student_id: 8)
StudentCohort.create(cohort_id: 1, student_id: 9)
StudentCohort.create(cohort_id: 1, student_id: 10)
StudentCohort.create(cohort_id: 1, student_id: 11)
StudentCohort.create(cohort_id: 1, student_id: 12)
StudentCohort.create(cohort_id: 1, student_id: 13)
StudentCohort.create(cohort_id: 1, student_id: 14)