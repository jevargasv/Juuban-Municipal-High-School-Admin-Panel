...
Teacher.create(first_name: "Setsuna", last_name: "Meioh", age: 24, date_of_birth: "October 29, 1978", salary: "$75,980", education: "Keio University - Ph.D", subject: "Physics")
Teacher.create(first_name: "Wataru", last_name: "Amanogawa", age: 35, date_of_birth: "April 12, 1966", salary: "$85,980", education: "Kyoto University - Ph.D", subject: "Astronomy")
Teacher.create(first_name: "Haruna", last_name: "Sakurada", age: 25, date_of_birth: "June 24, 1977", salary: "$65,456", education: "Osaka University - M.S.Ed", subject: "History")
Teacher.create(first_name: "Souichi", last_name: "Tomoe", age: 40, date_of_birth: "December 26, 1964", salary: "$85,988", education: "Waseda University - Ph.D", subject: "Chemistry")
Teacher.create(first_name: "Mamoru", last_name: "Chiba", age: 23, date_of_birth: "August 3, 1978", salary: "$65,382", education: "Harvard University - Ph.D", subject: "English")
Teacher.create(first_name: "Yumemi", last_name: "Yumeno", age: 22, date_of_birth: "February 28, 1979", salary: "$55,294", education: "Tokyo University of the Arts - M.S.Ed", subject: "Studio Art")
Teacher.create(first_name: "Shun", last_name: "Hayase", age: 27, date_of_birth: "January 8, 1973", salary: "$55,392", education: "Meiji University - M.S.Ed", subject: "Physical Education")
Teacher.create(first_name: "Takuzou", last_name: "Igarashi", age: 30, date_of_birth: "August 24, 1974", salary: "$55,392", education: "Tokyo University of the Arts - M.S.Ed", subject: "Music")
Teacher.create(first_name: "Ryo", last_name: "Urawa", age: 20, date_of_birth: "January 9, 1978", salary: "$75,980", education: "Keisen University - M.S.Ed", subject: "Mathematics")
Teacher.create(first_name: "Ikuko", last_name: "Tsukino", age: 40, date_of_birth: "September 28, 1964", salary: "$54,293", education: "Osaka University - M.S.Ed", subject: "Home Economics")
